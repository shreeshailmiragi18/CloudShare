...
public class ClerkJwksProvider {
    ...
    public ClerkJwksProvider(WebSocketTomcatWebServerFactoryCustomizer webSocketTomcatWebServerFactoryCustomizer) {
        this.webSocketTomcatWebServerFactoryCustomizer = webSocketTomcatWebServerFactoryCustomizer;
    }
